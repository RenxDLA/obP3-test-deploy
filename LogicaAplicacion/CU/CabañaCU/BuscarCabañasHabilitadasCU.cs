...
{
    public class BuscarCabañasHabilitadasCU : IBuscarCabañasHabilitadasCU
    {
        private IRepositorioCabaña _repo;
        public BuscarCabañasHabilitadasCU(IRepositorioCabaña repo)
        {
            _repo = repo;
        }
        public IEnumerable<CabañaDTO> BuscarHabilitadas()
        {
            try
            {
                return _repo.SearchByState().Select(c => new CabañaDTO(c));
            }
